...
import com.PortfolioNancy.NancyEcheverria.Dto.dtoExperiencia;
...
import com.PortfolioNancy.NancyEcheverria.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(),dtoexp.getPuesto(), dtoexp.getDescripcionE(),dtoexp.getFechaInicio(),dtoexp.getFechaFinalizacion());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        if(sExperiencia.existsByNombreE(dtoexp.getNombreE())&& 
            ...
            return new ResponseEntity(new Mensaje("Esa experiencianya existe"), HttpStatus.BAD_REQUEST);
