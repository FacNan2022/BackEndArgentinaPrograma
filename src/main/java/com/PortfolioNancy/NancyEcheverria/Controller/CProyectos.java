...
import com.PortfolioNancy.NancyEcheverria.Dto.dtoProyectos;
...
import com.PortfolioNancy.NancyEcheverria.Service.SProyectos;
...
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoPro){
        ...
        if(sProyectos.existsByNombre(dtoPro.getNombre()))
            return new ResponseEntity(new Mensaje("Este proyecto no existe"), HttpStatus.BAD_REQUEST);
        
        Proyectos proyectos= new Proyectos(dtoPro.getNombre(),dtoPro.getDescripcion(), dtoPro.getImagen(),dtoPro.getLink());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyectos dtoPro){
        ...
        if(sProyectos.existsByNombre(dtoPro.getNombre())&& 
                sProyectos.getByNombre(dtoPro.getNombre()).get().getId()!= id)
      ...
      proyectos.setDescripcion((dtoPro.getDescripcion()));
       proyectos.setImagen((dtoPro.getImagen()));
